...
function TestClass(testClass) {
  ...
  testMethods.forEach(function (method) {
    ...
    var promise = new Promise(function (resolve, reject) {
      ...
      try {
        ...
        _NodeSpringUtil2.default.log(_cliColor2.default.red('  ' + _cliColor2.default.red.bold(failedSymbol), method));
        _NodeSpringUtil2.default.log(_cliColor2.default.red('   ', err), '\n');
  ...
  Promise.all(promises).then(function (values) {
    ...
    if (methodStatus.failed.length > 0) _NodeSpringUtil2.default.log(' ', _cliColor2.default.red(methodStatus.failed.length, 'of', testMethods.length, 'tests failed for ' + _cliColor2.default.red.bold(className)));else _NodeSpringUtil2.default.log(' ', _cliColor2.default.blue('All tests for ' + _cliColor2.default.blue.bold(className) + ' have passed!'));
