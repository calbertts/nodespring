    ...
    var promise = new Promise(function (resolve, reject) {
      ...
      assertInstance.done = function () {
        ...
        if (assertInstance.ok.lastStack) {
          ...
          console.log(_cliColor2.default.red('  ' + failedSymbol, method));
          ...
          console.log(_cliColor2.default.green('  ' + passedSymbol, method), '\n');
...
function InjectMocks(type) {
  return function (target, property, descriptor) {
    ...
    switch (type.moduleType) {
      ...
      case 'implementation':
        metaInstance = _moduleContainer2.default.getModuleContainer()[type.interfaceName];
        objToTest = metaInstance.impl;
        break;

      case 'service':
        metaInstance = _moduleContainer2.default.getModuleContainer()[type.name];
        objToTest = metaInstance.impl;
        break;
