              ...
              if (Object.keys(dependencies).length > 0) {
                var _ret4 = function () {
                  ...
                  for (var property in dependencies) {
                    ...
                    dependenciesInstancesPromises.push(modulesContainer[moduleNeeded].getInstance());
                  }

                  return {
                    v: {
                      v: new Promise(function (resolve, reject) {
                        Promise.all(dependenciesInstancesPromises).then(function () {
                          moduleInfo.instanceResolvedValue = true;
                          console.log('listOfInstances', _arguments);
