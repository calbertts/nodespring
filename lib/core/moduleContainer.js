...
var ModuleContainer = (_temp = _class = function () {
  ...
  _createClass(ModuleContainer, null, [{
    ...
    value: function addController(moduleDef, path) {
       ...
       */
      moduleInfo.socketListeners.forEach(function (socketListenerData) {
              ...
              return new Promise(function (resolve, reject) {
                if (modulesContainer[type].impl) {
                  ...
                  if (modulesContainer[type].impl.scope) {
                    if (modulesContainer[type].impl.scope === 'singleton') resolve(modulesContainer[type].impl);else if (modulesContainer[type].impl.scope === 'prototype') resolve(new modulesContainer[type].impl());
                  } else {
                    resolve(modulesContainer[type].impl);
                  }
